...
export const RecyclerPlaceBidPage: React.FC<RecyclerPlaceBidPageProps> = ({
  onBack,
  onSubmitSuccess,
  itemTitle = 'Steel Scrap Bundles',
  itemFactory = 'Ahmed Factory',
  itemCategory = 'Ferrous Metal',
  itemQuantity = '50 Tons',
  currentHighestBid = '15,800 EGP / Ton'
}) => {
      ...
      <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-4 shadow-2xs">
        <div className="flex flex-wrap gap-6 items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="font-sans font-semibold text-base text-[#181C1C]">{itemTitle}</p>
          </div>
          <div className="space-y-1">
            <p className="font-mono text-xs text-[#44474F] uppercase tracking-wider">Factory</p>
            <p className="font-sans font-semibold text-base text-[#181C1C]">{itemFactory}</p>
          </div>
          <div className="space-y-1">
            <p className="font-mono text-xs text-[#44474F] uppercase tracking-wider">Category</p>
            <p className="font-sans font-semibold text-base text-[#181C1C]">{itemCategory}</p>
          </div>
          <div className="space-y-1">
            <p className="font-mono text-xs text-[#44474F] uppercase tracking-wider">Quantity</p>
            <p className="font-sans font-semibold text-base text-[#181C1C]">{itemQuantity}</p>
          </div>
          <div className="space-y-1">
            <p className="font-mono text-xs text-[#44474F] uppercase tracking-wider">Highest Bid</p>
            <p className="font-sans font-semibold text-base text-[#006A6A]">{currentHighestBid}</p>
          </div>
          <div className="space-y-1">
          ...
          <section className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-4 shadow-2xs">
            ...
            <div className="space-y-3 font-sans text-sm text-[#44474F]">
              <div className="flex justify-between">
                ...
                <span className="font-medium text-[#181C1C]">15,800 EGP</span>
              </div>
              <div className="flex justify-between">
