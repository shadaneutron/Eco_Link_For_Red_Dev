        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-4 shadow-2xs">
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                <h2 className="font-sans font-semibold text-2xl text-[#181C1C]">
                  {shipmentId} | Steel Scrap Bundles
                </h2>
            ...
            <div className="pt-3 border-t border-[#C4C6D0] grid grid-cols-1 md:grid-cols-3 gap-4 font-sans text-sm">
              <div className="space-y-1">
                ...
                <p className="font-medium text-[#181C1C]">Green Recycling Ltd.</p>
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <p className="font-medium text-[#181C1C]">Today 11:30 AM</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-6 shadow-2xs">
            ...
            <div className="relative px-2 py-4">
              ...
              <div className="absolute top-8 left-6 h-0.5 bg-[#006A6A] -z-0" style={{ width: '40%' }}></div>

              {/* Timeline Nodes */}
              <div className="relative z-10 flex justify-between items-start text-center">
                {/* Step 1: Driver Assigned */}
                <div className="flex flex-col items-center gap-2 w-20">
                  <div className="w-8 h-8 rounded-full bg-[#006A6A] text-white flex items-center justify-center shadow-xs">
                    <Check className="w-4 h-4" />
                  </div>
                  <p className="font-sans text-xs font-medium text-[#181C1C]">Driver Assigned</p>
                </div>
                ...
                <div className="flex flex-col items-center gap-2 w-20">
                  ...
                  <p className="font-sans text-xs font-semibold text-[#006A6A]">In Transit</p>
                </div>

                {/* Step 4: Arrived */}
                <div className="flex flex-col items-center gap-2 w-20">
                  <div className="w-8 h-8 rounded-full bg-[#E0E3E2] flex items-center justify-center"></div>
                  <p className="font-sans text-xs text-[#44474F]">Arrived</p>
                </div>

                {/* Step 5: Inspection */}
                <div className="flex flex-col items-center gap-2 w-20">
                  <div className="w-8 h-8 rounded-full bg-[#E0E3E2] flex items-center justify-center"></div>
                  <p className="font-sans text-xs text-[#44474F]">Inspection</p>
                </div>

                {/* Step 6: Received */}
                <div className="flex flex-col items-center gap-2 w-20">
                  <div className="w-8 h-8 rounded-full bg-[#E0E3E2] flex items-center justify-center"></div>
                  <p className="font-sans text-xs text-[#44474F]">Received</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-4 shadow-2xs">
              ...
              <div className="space-y-2.5 font-sans text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-[#44474F]">License</span>
            ...
            <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-4 shadow-2xs">
              ...
              <div className="space-y-2.5 font-sans text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-[#44474F]">Manager</span>
                  <span className="font-medium text-[#181C1C]">Omar Hassan</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#44474F]">Expected Time</span>
                  <span className="font-medium text-[#181C1C]">11:30 AM</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[#44474F]">Bay</span>
                  <span className="font-medium text-[#181C1C]">Bay 03</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-50 bg-[#000A1F]/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white border border-[#C4C6D0] rounded-lg p-6 max-w-md w-full space-y-4 shadow-xl">
            ...
            <p className="font-sans text-sm text-[#44474F]">
              Direct line to Mohamed Ali (Truck TR-208):
            </p>
