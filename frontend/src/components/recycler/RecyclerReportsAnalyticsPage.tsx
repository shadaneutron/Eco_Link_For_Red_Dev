...
export const RecyclerReportsAnalyticsPage: React.FC<RecyclerReportsAnalyticsPageProps> = ({
  ...
  return (
    <div className="space-y-8 bg-[#F7FAF9] min-h-screen">
      ...
      {/* Recycling Certificates Section */}
      <section className="space-y-4">
        <h3 className="font-sans font-semibold text-base text-[#181C1C]">Recycling Certificates</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Cert 1 */}
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-3 shadow-2xs">
            <div className="flex justify-between items-start">
              <h4 className="font-sans font-medium text-base text-[#181C1C]">
                Green Recycler Cert
              </h4>
              <span className="px-2 py-0.5 bg-[#8CF3F3] text-[#007070] text-[10px] font-semibold rounded font-sans">
                Active
              </span>
            </div>
            <p className="font-sans text-sm text-[#44474F]">#CERT-99281</p>
            <div className="text-xs text-[#44474F] font-sans space-y-0.5">
              <p>Issued: Jan 2024</p>
              <p>Expires: Jan 2025</p>
            </div>
            <div className="flex gap-2 pt-2">
              <button
                onClick={() => showNotification('Viewing Green Recycler Cert #CERT-99281...')}
                className="flex-1 py-1.5 border border-[#C4C6D0] rounded font-mono text-xs text-[#181C1C] hover:bg-[#E6E9E8] cursor-pointer"
              >
                View
              </button>
              <button
                onClick={() => showNotification('Downloading Green Recycler Cert #CERT-99281 PDF...')}
                className="flex-1 py-1.5 bg-[#006A6A] text-white rounded font-mono text-xs hover:bg-[#004F4F] cursor-pointer"
              >
                PDF
              </button>
            </div>
          ...
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-3 shadow-2xs">
            ...
            <p className="font-sans text-sm text-[#44474F]">#CERT-88102</p>
            <div className="text-xs text-[#44474F] font-sans space-y-0.5">
              <p>Issued: Mar 2024</p>
              <p>Expires: Mar 2025</p>
            </div>
            <div className="flex gap-2 pt-2">
              <button
                onClick={() => showNotification('Viewing Environmental Permit #CERT-88102...')}
                className="flex-1 py-1.5 border border-[#C4C6D0] rounded font-mono text-xs text-[#181C1C] hover:bg-[#E6E9E8] cursor-pointer"
              >
                View
              </button>
              <button
                onClick={() => showNotification('Downloading Environmental Permit #CERT-88102 PDF...')}
                className="flex-1 py-1.5 bg-[#006A6A] text-white rounded font-mono text-xs hover:bg-[#004F4F] cursor-pointer"
              >
                PDF
              </button>
          ...
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-5 space-y-3 shadow-2xs">
            <div className="flex justify-between items-start">
              <h4 className="font-sans font-medium text-base text-[#181C1C]">
                ISO 14001 Waste Recycler
              </h4>
              <span className="px-2 py-0.5 bg-[#8CF3F3] text-[#007070] text-[10px] font-semibold rounded font-sans">
                Active
              </span>
            </div>
            <p className="font-sans text-sm text-[#44474F]">#ISO-14001-EG</p>
            <div className="text-xs text-[#44474F] font-sans space-y-0.5">
              <p>Issued: Feb 2024</p>
              <p>Expires: Feb 2026</p>
            </div>
            <div className="flex gap-2 pt-2">
              <button
                onClick={() => showNotification('Viewing ISO 14001 Waste Recycler Certificate...')}
                className="flex-1 py-1.5 border border-[#C4C6D0] rounded font-mono text-xs text-[#181C1C] hover:bg-[#E6E9E8] cursor-pointer"
              >
                View
              </button>
              <button
                onClick={() => showNotification('Downloading ISO 14001 Certificate PDF...')}
                className="flex-1 py-1.5 bg-[#006A6A] text-white rounded font-mono text-xs hover:bg-[#004F4F] cursor-pointer"
              >
                PDF
              </button>
      ...
      <section className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg overflow-hidden shadow-2xs">
        <div className="p-5 border-b border-[#C4C6D0]">
          <h3 className="font-sans font-semibold text-base text-[#181C1C]">Compliance Reports</h3>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead className="bg-[#F1F4F3] font-mono text-xs text-[#44474F] uppercase tracking-wider">
            ...
            <tbody className="font-sans text-sm divide-y divide-[#C4C6D0]">
              <tr className="hover:bg-white/60 transition-colors">
                <td className="p-4 font-mono font-medium text-[#181C1C]">REP-442</td>
                <td className="p-4 text-[#181C1C]">SH-2026-014</td>
                <td className="p-4 text-[#181C1C]">Confirmed</td>
                <td className="p-4 text-[#181C1C]">Passed</td>
                <td className="p-4 text-[#181C1C]">Verified</td>
                <td className="p-4 text-[#44474F]">2024-05-21</td>
                <td className="p-4">
                  <button
                    onClick={() => showNotification('Downloading Compliance Report REP-442 PDF...')}
                    className="text-[#006A6A] hover:underline font-medium text-xs cursor-pointer"
                  >
                    Download PDF
                  </button>
              ...
              <tr className="hover:bg-white/60 transition-colors">
                <td className="p-4 font-mono font-medium text-[#181C1C]">REP-439</td>
                <td className="p-4 text-[#181C1C]">SH-2026-012</td>
                <td className="p-4 text-[#181C1C]">In Progress</td>
                <td className="p-4 text-[#181C1C]">Pending</td>
                <td className="p-4 text-[#181C1C]">Pending</td>
                <td className="p-4 text-[#44474F]">2024-05-19</td>
                <td className="p-4">
                  <button
                    onClick={() => showNotification('Downloading Compliance Report REP-439 PDF...')}
                    className="text-[#006A6A] hover:underline font-medium text-xs cursor-pointer"
                  >
                    Download PDF
                  </button>
      ...
      {/* ESG & Sustainability Reports Section */}
      <section className="space-y-4">
        <h3 className="font-sans font-semibold text-base text-[#181C1C]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {/* Card 1 */}
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-4 space-y-2 shadow-2xs">
            <h4 className="font-sans font-medium text-base text-[#181C1C]">Monthly ESG Report</h4>
            <p className="font-sans text-xs text-[#44474F]">Generated: May 2024</p>
            <div className="flex gap-3 pt-2">
              <button
                onClick={() => showNotification('Opening Monthly ESG Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                View
              </button>
              <button
                onClick={() => showNotification('Downloading Monthly ESG Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                Download
              </button>
          ...
          {/* Card 2 */}
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-4 space-y-2 shadow-2xs">
            <h4 className="font-sans font-medium text-base text-[#181C1C]">Carbon Reduction</h4>
            <p className="font-sans text-xs text-[#44474F]">Generated: May 2024</p>
            <div className="flex gap-3 pt-2">
              <button
                onClick={() => showNotification('Opening Carbon Reduction Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                View
              </button>
              <button
                onClick={() => showNotification('Downloading Carbon Reduction Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                Download
              </button>
          ...
          {/* Card 3 */}
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-4 space-y-2 shadow-2xs">
            <h4 className="font-sans font-medium text-base text-[#181C1C]">Circular Economy</h4>
            <p className="font-sans text-xs text-[#44474F]">Generated: May 2024</p>
            <div className="flex gap-3 pt-2">
              <button
                onClick={() => showNotification('Opening Circular Economy Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                View
              </button>
              <button
                onClick={() => showNotification('Downloading Circular Economy Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                Download
              </button>
          ...
          {/* Card 4 */}
          <div className="bg-[#F7FAF9] border border-[#C4C6D0] rounded-lg p-4 space-y-2 shadow-2xs">
            <h4 className="font-sans font-medium text-base text-[#181C1C]">Waste Recovery</h4>
            <p className="font-sans text-xs text-[#44474F]">Generated: May 2024</p>
            <div className="flex gap-3 pt-2">
              <button
                onClick={() => showNotification('Opening Waste Recovery Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                View
              </button>
              <button
                onClick={() => showNotification('Downloading Waste Recovery Report...')}
                className="text-[#006A6A] hover:underline font-mono text-xs font-semibold cursor-pointer"
              >
                Download
              </button>
